...
class InMemoryTaskStore:
    ...
    **Not a deployable backend, and not for the usual reason.** An in-memory
    *session* store is merely restart-fragile; an in-memory *task* store is
    broken by design, because a task is created on a web worker and finished
